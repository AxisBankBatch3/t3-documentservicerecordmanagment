...
class PolicyServiceImpl(
    ...
    var bucketName: String? = "deltabank"
    ...
    override fun downloadProofFile(folder: String?, fileName: String?): ByteArray? {
        ...
        val s3Object =
            s3Client.getObject("deltabank",folder.toString() + "/" + fileName.toString())
    ...
    override fun submitDocuments(
        ...
        relatedDocuments :MultipartFile,
            ...
            if(policyHolderRepository.existsByPolicyNumber(policyNumber)){
                ...
                val relatedFile: File? = convertMultipartFileToFile(relatedDocuments)
                val date = Date()
                ...
                val relatedFileName: String? = relatedDocuments?.originalFilename
